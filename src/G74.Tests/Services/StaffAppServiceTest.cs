...
[TestSubject(typeof(StaffAppService))]
public class StaffAppServiceTest
{
    ...
    public async Task GetAll_ReturnsAllStaff()
    {
        ...
        // Act
        IEnumerable<StaffDto> result = await _staffAppService.GetAll();
    ...
    {
        // Arrange
        _mockStaffRepository.Setup(repo => repo.GetStaffByLicenseNumberAsync(_validStaff.LicenseNumber.Value))
            .ReturnsAsync(_validStaff);

        // Act
        var result = await _staffAppService.GetByLicenseNumber(_validStaff.LicenseNumber.Value);
    ...
    {
        // Arrange
        _mockStaffRepository.Setup(repo => repo.GetStaffByLicenseNumberAsync("nonexistent"))
            .ReturnsAsync((Staff)null);

        // Act
        var result = await _staffAppService.GetByLicenseNumber("nonexistent");
    ...
    public async Task Add_WithNewStaff_ReturnsCreatedStaffDto()
    {
        ...
        // Act
        var result = await _staffAppService.Add(_validStaffDto);
    ...
    public async Task Add_WithExistingLicenseNumber_ThrowsException()
    {
        ...
        await Assert.ThrowsAsync<Exception>(async () => 
            await _staffAppService.Add(_validStaffDto));
    }
    ...
    public async Task Update_WithExistingStaff_ReturnsUpdatedStaffDto()
    {
        ...
        // Act
        var result = await _staffAppService.Update(_validStaff.LicenseNumber.Value, updateDto);
    ...
    public async Task Deactivate_WithExistingStaff_ReturnsDeactivatedStaffDto()
    {
        ...
        // Act
        var result = await _staffAppService.Deactivate(_validStaff.LicenseNumber.Value);
    ...
    public async Task Deactivate_WithNonExistingStaff_ReturnsNull()
    {
        ...
        // Act
        var result = await _staffAppService.Deactivate("nonexistent");
